...
from .models import Profile, PtoHistory, Schedule
...
# Prepare the Schedule model to be appended to the end of the user model for easier viewing in the django admin.
...
class CustomUserAdmin(UserAdmin):
    inlines = (ProfileInline, ScheduleInline,)
